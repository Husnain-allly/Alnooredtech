...
import img2Front from "../pics/Book1-Front.png"; // change to your actual file
import img2Side from '../pics/Book1-Page.jpg';   // change to your actual file
import img2Back from "../pics/Book1-Back.jpg";   // change to your actual file
...
Also, by practicing each quote every day, you will be able to reach one step higher in the sight of Allah Almighty, to whom we shall return. So, it is a simple guide to be a humble and knowledgeable person with easy understanding of his quotes.`,
...

  {
    ...
    pricePKR: 1200, 
    images: [img2Front, img2Side, img2Back].filter(Boolean), 
